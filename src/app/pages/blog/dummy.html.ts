export const DUMMY_HTML = `
      <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.
       Aliquam eget vestibulum nibh. Duis dapibus est nec neque fermentum, eu congue elit pulvinar.
        Morbi non egestas urna. Duis dignissim varius est nec elementum. Ut at lorem quis diam tempus bibendum.
        Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Etiam tellus enim, effici
      tur ac volutpat sed, porta non ipsum. Fusce quis diam congue, semper augue in, imperdiet ligula.</p>
